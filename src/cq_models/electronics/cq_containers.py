...
Note: These classes are kept for backward compatibility with cq-electronics.
For new modules outside of electronics/, prefer using cq_models.base instead.
The interfaces are fully compatible:
  - CqWorkplaneContainer ↔ CqWorkplaneModel
  - CqAssemblyContainer  ↔ CqAssemblyModel
"""
